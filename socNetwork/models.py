...
class CommentComment(models.Model):
    ...
    author = models.ForeignKey('UserCustomuser')
...
class SocnetComment(models.Model):
    text = models.TextField()
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    author = models.ForeignKey(UserCustomuser)
    ...
    class Meta:
        managed = False
        db_table = 'socNet_comment'


class SocnetLike(models.Model):
    is_liked = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'socNet_like'


class SocnetPost(models.Model):
    text = models.TextField()
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    title = models.CharField(max_length=255)
